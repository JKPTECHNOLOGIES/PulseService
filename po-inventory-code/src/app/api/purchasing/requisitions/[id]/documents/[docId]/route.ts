/**
 * Requisition Document Detail API Routes
 *
 * GET /api/purchasing/requisitions/:id/documents/:docId - Get single document metadata
 * PATCH /api/purchasing/requisitions/:id/documents/:docId - Update document metadata
 * DELETE /api/purchasing/requisitions/:id/documents/:docId - Delete document
 */
...
/**
 * GET /api/purchasing/requisitions/:id/documents/:docId
...
/**
 * PATCH /api/purchasing/requisitions/:id/documents/:docId
...
/**
 * DELETE /api/purchasing/requisitions/:id/documents/:docId
 * Delete document
 */
