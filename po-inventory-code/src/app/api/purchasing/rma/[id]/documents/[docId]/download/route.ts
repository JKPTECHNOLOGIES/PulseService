/**
 * RMA Document Download API Route
 *
 * GET /api/purchasing/rma/:id/documents/:docId/download - Download or view document
 */
...
/**
 * GET /api/purchasing/rma/:id/documents/:docId/download
