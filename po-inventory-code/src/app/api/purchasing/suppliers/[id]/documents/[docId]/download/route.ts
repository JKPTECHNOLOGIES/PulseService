/**
 * Supplier Document Download API Route
 *
 * GET /api/purchasing/suppliers/:id/documents/:docId/download - Download or view document
 */
...
/**
 * GET /api/purchasing/suppliers/:id/documents/:docId/download
