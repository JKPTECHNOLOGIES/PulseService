/**
 * Purchase Order Document Detail API Routes
 *
 * GET /api/purchasing/purchase-orders/:id/documents/:docId - Get single document metadata
 * PATCH /api/purchasing/purchase-orders/:id/documents/:docId - Update document metadata
 * DELETE /api/purchasing/purchase-orders/:id/documents/:docId - Delete document
 */
...
/**
 * GET /api/purchasing/purchase-orders/:id/documents/:docId
...
/**
 * PATCH /api/purchasing/purchase-orders/:id/documents/:docId
...
/**
 * DELETE /api/purchasing/purchase-orders/:id/documents/:docId
 * Delete document
 */
