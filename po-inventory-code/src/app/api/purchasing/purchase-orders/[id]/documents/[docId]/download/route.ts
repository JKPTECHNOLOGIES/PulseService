/**
 * Purchase Order Document Download API Route
 *
 * GET /api/purchasing/purchase-orders/:id/documents/:docId/download - Download or view document
 */
...
/**
 * GET /api/purchasing/purchase-orders/:id/documents/:docId/download
