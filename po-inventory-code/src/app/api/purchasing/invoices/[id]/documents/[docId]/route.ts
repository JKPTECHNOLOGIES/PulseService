/**
 * Invoice Document Detail API Routes
 *
 * GET /api/purchasing/invoices/:id/documents/:docId - Get single document metadata
 * PATCH /api/purchasing/invoices/:id/documents/:docId - Update document metadata
 * DELETE /api/purchasing/invoices/:id/documents/:docId - Delete document
 */
...
/**
 * GET /api/purchasing/invoices/:id/documents/:docId
...
/**
 * PATCH /api/purchasing/invoices/:id/documents/:docId
...
/**
 * DELETE /api/purchasing/invoices/:id/documents/:docId
 * Delete document
 */
