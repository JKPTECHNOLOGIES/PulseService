/**
 * Invoice Document Download API Route
 *
 * GET /api/purchasing/invoices/:id/documents/:docId/download - Download or view document
 */
...
/**
 * GET /api/purchasing/invoices/:id/documents/:docId/download
