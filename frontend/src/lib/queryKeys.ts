export const queryKeys = {
  ...
  // Metadata / lookups (DB-driven enums)
  ...
  technicians: {
    ...
    list: (params?: Record<string, unknown>) =>
      ["technicians", "list", params] as const,
  ...
  estimates: {
    ...
    list: (params?: Record<string, unknown>) =>
      ["estimates", "list", params] as const,
  ...
  pricebook: {
    ...
    items: (params?: Record<string, unknown>) =>
      ["pricebook", "items", params] as const,
  },
  ...
  inventory: {
    ...
    transactions: (itemId: string) =>
      ["inventory", "transactions", itemId] as const,
  },
  ...
  agreements: {
    ...
    list: (params?: Record<string, unknown>) =>
      ["agreements", "list", params] as const,
  ...
  reports: {
    ...
    jobs: (params?: Record<string, unknown>) =>
      ["reports", "jobs", params] as const,
    technicians: (params?: Record<string, unknown>) =>
      ["reports", "technicians", params] as const,
