...
const variantClasses: Record<string, string> = {
  primary:
    "bg-primary-600 text-oncolor hover:bg-primary-700 focus:ring-primary-500 border-transparent",
  secondary:
    "bg-gray-100 text-gray-700 hover:bg-gray-200 focus:ring-gray-500 border-transparent",
  danger:
    "bg-red-600 text-oncolor hover:bg-red-700 focus:ring-red-500 border-transparent",
  ghost:
